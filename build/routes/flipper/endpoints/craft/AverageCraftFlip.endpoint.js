...
exports.AverageCraftFlipEndpoint = void 0;
var FlipperRouter_router_1 = __importDefault(require("../../FlipperRouter.router"));
var AverageCraftFlipEndpoint = /** @class */ (function () {
    function AverageCraftFlipEndpoint() {
    }
    AverageCraftFlipEndpoint.AverageCraftFlip = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                FlipperRouter_router_1.default.GetRouter().post('/craft/average', function (req, res, next) {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
    ...
    return AverageCraftFlipEndpoint;
}());
exports.AverageCraftFlipEndpoint = AverageCraftFlipEndpoint;
